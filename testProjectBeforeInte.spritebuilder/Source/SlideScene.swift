...
class MainScene: CCNode, CCScrollViewDelegate{
    
    weak var _scrollView: CCScrollView!
    weak var _num1: CCSprite!
    weak var _num2: CCSprite!
    weak var _num3: CCSprite!
    ...
    func goToPin(){
        print("1")
        let gameplayScene = CCBReader.load(asScene:"pinCode")
